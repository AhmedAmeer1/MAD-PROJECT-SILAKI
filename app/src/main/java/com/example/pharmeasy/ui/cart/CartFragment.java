...
import com.example.pharmeasy.Address;
...
public class CartFragment extends Fragment{
    ...
    float totalCost = 0;
    Total_cost_java total=new Total_cost_java();
    FirebaseAuth fAuth;
...
//                        Toast.makeText(getContext(), "Successfully Updated", Toast.LENGTH_LONG).show();
                        ...
                        db = FirebaseDatabase.getInstance().getReference().child("Total_cost");
                        int final_amount= (int) totalCost;
                        ...
                        total.setId(uid);
                        total.setTotal_cost(final_amount);

                        db.child(uid).setValue(total);
    ...
    public static class CartViewHolder extends RecyclerView.ViewHolder{
        ...
        public CartViewHolder(@NonNull View itemView){
            ...
            updateBtn=cartView.findViewById(R.id.purchase);
